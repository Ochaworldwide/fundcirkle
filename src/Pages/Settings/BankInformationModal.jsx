...
//           ROUTES.ACCOUNT.GET_USER_ACCOUNT
//         );
//         setAccountDetails(response.data.data).bank_details;
...
//   const copyToClipboard = (text) => {
//     navigator.clipboard.writeText(text);
//     toast.success("Copied to clipboard!"); // Use toast instead of alert
//   };
