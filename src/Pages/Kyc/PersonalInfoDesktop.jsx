...
const PersonalInfoDesktop = () => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate("/uploaddocumentdesktop");
  };
    ...
    <div className="w-full p-6 font-poppins">
      ...
      <div className="bg-white rounded-lg w-full">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          ...
          <div className="flex justify-between w-[80%] py-5 mx-auto bg-white">
            <button
              type="button"
            ...
            <button
              type="submit"
              className="w-[40%] bg-green-600 text-white font-bold py-4 rounded-md cursor-pointer"
            >
              Continue
            </button>
          </div>
