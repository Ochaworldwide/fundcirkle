...
//       <Link
//         to="/get-started"
//         className="swiper-button-prev-custom absolute left-5 text-[#00000080] top-[100%] -translate-y-1/2  p-3 rounded-full text-[18px] z-10"
//         aria-label="Back"
//       >
//         Back
//       </Link>
...
//       {/* Custom Next Button */}
//       <button
//         className="swiper-button-next-custom bg-[#00943F] absolute right-5 top-[100%] -translate-y-1/2  p-3 rounded-full border z-10"
//         aria-label="Next"
//       >
...
//         }}
//         modules={[EffectCoverflow, Navigation, Pagination]} // Include Pagination module
//         className="my-swiper"
//         // className="my-swiper bg-[url('/images/splash-bg.svg')] bg-no-repeat bg-top bg-contain"
//       >
