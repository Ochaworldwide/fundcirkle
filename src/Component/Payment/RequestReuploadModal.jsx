...
//   const { isModalOpen, closeModal, modalType,openModal,modalData } = useModal();
...
// import axiosInstance from "../utils/axiosInstance"; // Ensure you have an axios instance set up

const RequestReuploadModal = () => {
  const { isModalOpen, closeModal, modalType, openModal, modalData } =
    useModal();
  ...
  const handleRequestReupload = async () => {
    try {
      const response = await axiosInstance.post(`/cirkles/${modalData?.id}/reupload`, {
        user: modalData?.user_id, // Replace with actual user data if available
