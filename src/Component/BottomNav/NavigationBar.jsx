...
const NavigationBar = () => {
  ...
  const getIconColor = (tab) => (activeTab === tab ? "#00943F" : "#141B34"); // Active tab icon color
  ...
  return (
    <div className="flex flex-col items-center absolute bottom-0 right-0 left-0 z-50">
